...
namespace Drupal\agree_terms\Plugin\Field\FieldFormatter;
...
/**
 * Plugin implementation of the 'agree_terms' formatter.
 *
 * @FieldFormatter(
 *   id = "agree_terms_formatter",
 ...
 * )
 */
class AgreeTermsFormatter extends FormatterBase {
